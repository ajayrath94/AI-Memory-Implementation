...
const styles = StyleSheet.create({
  ...
  tabText:         { color: theme.textMuted, fontSize: 14 },
  ...
  factText:        { color: theme.text, fontSize: 14, flex: 1 },
  ...
  fpLabel:         { color: theme.textMuted, fontSize: 13 },
  fpValue:         { color: theme.text, fontSize: 13, fontWeight: '500', flex: 1, textAlign: 'right' },
  trendRow:        { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  trendPillar:     { color: theme.text, fontSize: 13 },
  trendDir:        { fontSize: 13, fontWeight: '500' },
  updatedAt:       { color: theme.textMuted, fontSize: 11, textAlign: 'center' },
  ...
  profileMeta:     { color: theme.textMuted, fontSize: 13 },
  ...
  profileRowLabel: { color: theme.textMuted, fontSize: 13, width: 80 },
  profileRowValue: { color: theme.text, fontSize: 13, flex: 1 },
  ...
  interestRow:     { gap: 6 },
  interestCategory: { color: theme.textMuted, fontSize: 12, textTransform: 'capitalize' },
